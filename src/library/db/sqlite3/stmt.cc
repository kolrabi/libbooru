...
namespace Booru::DB::Sqlite3
{
    ...
    ExpectedStmt DatabasePreparedStatementSqlite3::BindValue(StringView const &_Name, ByteSpan const &_Blob)
    {
        INTEGER paramIndex;
        ...
        return {shared_from_this(), Sqlite3ToResult(sqlite3_bind_blob(m_Handle, paramIndex, blobCopy, _Blob.size_bytes(), ::free))};
    }

    ExpectedStmt DatabasePreparedStatementSqlite3::BindValue(StringView const &_Name, FLOAT _Value)
    {
        INTEGER paramIndex;
        CHECK_RETURN_RESULT_ON_ERROR(GetParamIndex(_Name, paramIndex));
        if (paramIndex == 0)
        ...
        return {shared_from_this(), Sqlite3ToResult(sqlite3_bind_double(m_Handle, paramIndex, _Value))};
    }

    ExpectedStmt DatabasePreparedStatementSqlite3::BindValue(StringView const &_Name, INTEGER _Value)
    {
        INTEGER paramIndex;
        CHECK_RETURN_RESULT_ON_ERROR(GetParamIndex(_Name, paramIndex));
        if (paramIndex == 0)
        ...
        return {shared_from_this(), Sqlite3ToResult(sqlite3_bind_int64(m_Handle, paramIndex, _Value))};
    }

    ExpectedStmt DatabasePreparedStatementSqlite3::BindValue(StringView const &_Name, TEXT const &_Value)
    {
        INTEGER paramIndex;
        CHECK_RETURN_RESULT_ON_ERROR(GetParamIndex(_Name, paramIndex));
        if (paramIndex == 0)
        ...
        return {shared_from_this(), Sqlite3ToResult(sqlite3_bind_text(m_Handle, paramIndex, stringCopy, -1, ::free))};
    }
    ...
    ExpectedStmt DatabasePreparedStatementSqlite3::BindNull(StringView const &_Name)
    {
        ...
        return {shared_from_this(), Sqlite3ToResult(sqlite3_bind_null(m_Handle, paramIndex))};
    }

    ExpectedStmt DatabasePreparedStatementSqlite3::GetColumnValue(int _Index, ByteVector &_Blob)
    {
    ...
    ExpectedStmt DatabasePreparedStatementSqlite3::GetColumnValue(int _Index, FLOAT &_Value)
    {
        if (ColumnIsNull(_Index))
        {
            return ResultCode::ValueIsNull;
    ...
    ExpectedStmt DatabasePreparedStatementSqlite3::GetColumnValue(int _Index, INTEGER &_Value)
    {
        if (ColumnIsNull(_Index))
        {
            return ResultCode::ValueIsNull;
    ...
    ExpectedStmt DatabasePreparedStatementSqlite3::GetColumnValue(int _Index, TEXT &_Value)
    {
        if (ColumnIsNull(_Index))
        {
            return ResultCode::ValueIsNull;
